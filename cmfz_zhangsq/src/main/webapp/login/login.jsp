    ...
    <script>
        ...
        $(function () {
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${path}/admin/getImageCode?tiem="+new Date().getTime())
            });


            //表单自动验证
            $.extend($.validator.messages, {
                required: "<span style='color: #e65947'>这是必填字段</span>",
                minlength: $.validator.format("<span style='color: #e65947'>最少要输入6个字符</span>")
            });
...
<!-- Top content -->
<div class="top-content" style="background-image: url('${path}/login/assets/img/backgrounds/1.jpg')">
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv" style="color:#ac2925"></span>
                            ...
                            <div class="form-group" id="codeDiv">
                               <!-- <label class="sr-only" for="form-code">Code</label>-->
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/getImageCode" onclick="changeImages()">
